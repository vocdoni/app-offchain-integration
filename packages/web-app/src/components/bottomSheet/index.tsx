...
const StyledMotionContainer = styled(motion.div).attrs({
  className:
    'bg-ui-50 block left-0 fixed bottom-0 tablet:bottom-3 w-full tablet:w-max rounded-t-xl tablet:rounded-xl tablet:left-0 tablet:right-0 tablet:mx-auto z-50',
})`
  &:before {
    content: '';
